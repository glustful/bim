...
public final class MemoryCacheUtils {
	 ...
	 */
	public static List<BitmapResult> findCachedBitmapsForImageUri(String imageUri, MemoryCache memoryCache) {
		List<BitmapResult> values = new ArrayList<BitmapResult>();
