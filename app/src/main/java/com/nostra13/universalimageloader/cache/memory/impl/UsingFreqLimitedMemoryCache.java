...
public class UsingFreqLimitedMemoryCache extends LimitedMemoryCache {
	 ...
	 */
	private final Map<BitmapResult, Integer> usingCounts = Collections.synchronizedMap(new HashMap<BitmapResult, Integer>());
	...
	protected BitmapResult removeNext() {
		...
		BitmapResult leastUsedValue = null;
		Set<Entry<BitmapResult, Integer>> entries = usingCounts.entrySet();
