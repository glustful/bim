...
public abstract class LimitedMemoryCache extends BaseMemoryCache {
	 ...
	 * time)
	 */
	private final List<BitmapResult> hardCache = Collections.synchronizedList(new LinkedList<BitmapResult>());
	...
	public boolean put(String key, BitmapResult value) {
		...
		if (valueSize < sizeLimit) {
			while (curCacheSize + valueSize > sizeLimit) {
				BitmapResult removedValue = removeNext();
	...
	protected abstract int getSize(BitmapResult value);

	protected abstract BitmapResult removeNext();
}
