...
public abstract class BaseMemoryCache implements MemoryCache {
	...
	private final Map<String, Reference<BitmapResult>> softMap = Collections.synchronizedMap(new HashMap<String, Reference<BitmapResult>>());

	@Override
	public BitmapResult get(String key) {
		BitmapResult result = null;
		Reference<BitmapResult> reference = softMap.get(key);
		if (reference != null) {
	...
	public BitmapResult remove(String key) {
		Reference<BitmapResult> bmpRef = softMap.remove(key);
	...
	protected abstract Reference<BitmapResult> createReference(BitmapResult value);
}
